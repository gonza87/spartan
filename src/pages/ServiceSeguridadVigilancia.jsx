    ...
    <>
      <div className="hero-seguridadVigilancia">
        <div className="seguridadVigilancia-content container">
          <h2 className="titleseguridadVigilancia">Seguridad y vigilancia</h2>
          <div className="row seguridadVigilancia-content">
            <div className="col-12 col-lg-5">
              <div className="contImgVigilancia animate__animated animate__zoomIn">
                <img
            ...
            <div className="col-12 col-lg-7 mt-3">
              ...
              >
                ...
                <ul>
                  ...
                  <li>
                    Controles de Accesos: El vigilante realiza controles en
                    puntos de entrada y salida, verificando la identidad y
                    autorizaciones de las personas que ingresan o salen del
                    lugar. Esto previene el acceso no autorizado y permite
              ...
              >
                ...
                <ul>
                  <li>
                    ...
                    pueden incluir la retención del sospechoso y la protección
                    de la escena del crimen.
                  </li>
                  <li>
                    Comunicación Efectiva: Es fundamental que el vigilante
                    comunique cualquier suceso detectado a sus superiores y, si
                    es necesario, a las autoridades correspondientes. Una
                  ...
                  <li>
                    ...
                    cámaras de seguridad y testimonios, que pueden ser
                    esenciales para una investigación posterior.
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-12 col-lg-6">
              ...
              >
                <p>
                  <strong>
                    Importancia de la Persona Física y el Uniforme
                  </strong>
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    uniformado genera un sentido de protección entre los
                    empleados y visitantes, creando un ambiente de confianza.
                  </li>
                  <li>
