          ...
          <div className="col-12 col-lg-7">
            ...
            <ul>
              ...
              <li>
                ...
                de las personas que ingresan o salen del lugar. Esto previene el
                acceso no autorizado y permite mantener un registro de
                visitantes.
              </li>
              <li>
                Rondas Perimetrales: Las rondas regulares por el perímetro y
                áreas sensibles del establecimiento permiten detectar y prevenir
                posibles vulnerabilidades, como puertas abiertas o cerraduras
                dañadas.
              </li>
            </ul>
          </div>
          <div className="col-12 col-lg-6">
            ...
            <ul>
              <li>
                ...
                actúa de inmediato según los protocolos establecidos, que pueden
                incluir la retención del sospechoso y la protección de la escena
                del crimen.
              </li>
              <li>
                Comunicación Efectiva: Es fundamental que el vigilante comunique
                cualquier suceso detectado a sus superiores y, si es necesario,
                a las autoridades correspondientes. Una comunicación clara y
                oportuna puede ser crucial para una resolución efectiva del
                incidente.
              </li>
              <li>
          ...
          <div className="col-12 col-lg-6">
            ...
            <ul>
              <li>
                ...
                autoridad y seguridad, lo que puede influir en el comportamiento
                de las personas y promover un entorno seguro.
              </li>
              <li>
                Confianza y Seguridad: La presencia física de un vigilante
                uniformado genera un sentido de protección entre los empleados y
                visitantes, creando un ambiente de confianza.
              </li>
              <li>
                Profesionalismo: Un uniforme bien cuidado y una actitud
                profesional reflejan el compromiso del vigilante con su trabajo
                y su capacidad para manejar situaciones de seguridad con
                eficacia.
              </li>
            </ul>
          </div>
