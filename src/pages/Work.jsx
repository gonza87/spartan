    ...
    <>
      <div className="hero-work">
        <div className="work-content container">
          <h2 className="titleWork">Trabaja con nosotros</h2>
            ...
            <div className="col-12 d-flex justify-content-center">
              <div className="contNuestraCultura">
                ...
                <p>
                  ...
                  firmemente que nuestras personas son nuestro mayor recurso y
                  la clave de nuestro éxito. Nuestro equipo está compuesto por
                  ...
                  enorgullecemos de crear un entorno de trabajo donde cada
                  miembro del equipo se siente valorado y respetado. Fomentamos
                  una cultura de inclusión, colaboración y crecimiento
                  profesional, donde cada persona tiene la oportunidad de
