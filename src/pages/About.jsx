        ...
        <div className="row about-content">
            ...
            >
              ...
              <ul>
                ...
                <li>
                  ...
                  nuestra prioridad. Ofrecemos un servicio atento y profesional
                  en todo momento.
                </li>
              </ul>
            </div>
          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <p>
                En <span className="titleSparta">Spartan</span> Seguridad,
                entendemos que cada cliente tiene necesidades únicas. Por ello,
                ofrecemos precios flexibles y varias opciones de contratación
                para adaptarnos a sus requerimientos:
              </p>
              <ul>
